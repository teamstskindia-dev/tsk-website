...
export const metadata: Metadata = {
  title: "Privacy Policy | TSK India Buildcon",
  description: "Privacy Policy for TSK India Buildcon.",
};
  ...
  return (
    <LegalPage title="Privacy Policy" updated="January 1, 2024">
      <p className="text-sm leading-relaxed text-text-muted sm:text-base">
        TSK India Buildcon values your trust and is committed to protecting
      ...
      <LegalSection number="2" title="Data Collection &amp; Use">
        <p>
          ...
          at TSK India Buildcon collect personal information to provide you
        ...
        <p>
          ...
          TSK India Buildcon will never provide your personal information to
      ...
      <LegalSection number="5" title="Opt-Out Rights">
        ...
        <div className="rounded-2xl border border-border bg-bg-elevated p-5">
          ...
          <p className="mt-1">TSK India Buildcon</p>
